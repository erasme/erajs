	...
	updateSizes: function() {
		...
		if(this.orientation == 'vertical') {
			if(this.text != undefined) {
				...
				// content + text
				else if(this.buttonContent != undefined) {
					this.textBox.setMarginLeft(spacing + 2);
					this.textBox.setMarginRight(spacing + 2);
